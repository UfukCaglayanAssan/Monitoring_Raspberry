...
def reset_period():
    ...
    # Periyot bittiğinde periyot verilerini temizleme - veriler kalmalı!
    # Yeni periyot başladığında UPSERT ile güncellenecek
    print("✓ Periyot sıfırlandı - mevcut veriler korunuyor")
...
# SNMP trap fonksiyonları kaldırıldı - sadece modbus_sqlite.py'de kullanılıyor

# SNMP server fonksiyonu kaldırıldı - sadece modbus_sqlite.py'de kullanılıyor
